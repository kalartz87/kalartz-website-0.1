...
import { Bell, Settings, Search, UserCircle, ChevronDown, LogOut } from 'lucide-react';
...
const VendorHeader = () => {
  ...
  return (
    <header className="bg-white shadow-sm fixed top-0 left-64 right-0 z-30 h-16 border-b border-gray-200">
      <div className="px-6 h-full">
        <div className="flex items-center justify-between h-full">
          {/* Search Bar - Mimicking AdminHeader style */}
          ...
          {/* Right side actions - Mimicking AdminHeader style */}
