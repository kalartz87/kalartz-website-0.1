...
import { Settings, Shield, Truck, Percent, Globe, Image as ImageIcon, Save, CreditCard, Zap, Smartphone } from 'lucide-react';
...
const AdminSettings = () => {
  ...
  const settingsSections = [
    ...
    },
    {
      ...
      icon: CreditCard,
      description: "Configure payment gateways like Stripe, Razorpay, and PhonePe.",
      fields: [
        { name: 'stripeApiKey', label: 'Stripe Publishable API Key', type: 'text', placeholder: 'pk_live_...' },
        { name: 'razorpayKeyId', label: 'Razorpay Key ID', type: 'text', placeholder: 'rzp_live_...' },
        { name: 'phonepeMerchantId', label: 'PhonePe Merchant ID', type: 'text', placeholder: 'MERCHANT_ID' },
      ]
    },
    {
      id: 'shipping',
      ...
      icon: Truck,
      description: "Set up shipping methods and integrations like Shiprocket.",
      fields: [
        { name: 'shippingFlatRate', label: 'Default Shipping Flat Rate ($)', type: 'number', step: '0.01' },
        { name: 'shiprocketApiKey', label: 'Shiprocket API Key', type: 'text', placeholder: 'Your Shiprocket API Key' },
      ]
    },
    {
      id: 'seo',
